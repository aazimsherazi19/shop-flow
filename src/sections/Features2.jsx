...
const Features2 = ({ boxes }) => {
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 py-8 sm:px-12 py-10 md:px-16 md:py-12 lg:px-20 lg: py-14'>
      {boxes.map((box, index)=> (
       <div key={index} className='px-2 py-4 flex flex-col items-center justify-center gap-4'>
             {/* Logo */}
         <div className='px-2 py-2 rounded-lg bg-primary mb-1'>
         ...
         <div className='flex flex-col items-center'>
           ...
           <p className='font-normal text-[12px] md:text-[12px] text-second text-center'>{box.text}</p>
         </div>
      </div>
      ))}
